    ...
    darkMode: function () {
        ...
        if (e.isVariableDefined(dark)) {
          ...
          var changeThemeToDark = () => {
            ...
            if(dir == 'rtl') {
                style.setAttribute('href', 'resources/css/style-dark-rtl.css');
            } else {
                style.setAttribute('href', 'resources/css/style-dark.css');
            }
          ...
          var changeThemeToLight = () => {
            ...
            if(dir == 'rtl') {
                style.setAttribute('href', 'resources/css/style-rtl.css');
            } else {
                style.setAttribute('href', 'resources/css/style.css');
            }
